...
//	
//	public String verifyUser(@RequestBody JSONObject user) {
//
//		String newEmail=user.getEmail();
//		Optional<User> current= userRepository.findByEmail(newEmail);
//		if(current.isPresent()) {
//			if(user.password ===current.get().getPassword()){
...
//	}
	...
	@PutMapping(value = "/order", consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	...
	@PostMapping(value = "/foodProducts", consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	...
	@GetMapping(value = "/foodProducts/{id}", produces = { MediaType.APPLICATION_JSON_VALUE })
	public FoodProduct getFoodProductById(@PathVariable int id) {
		return foodProductService.getFoodProductById(id);
	}

	@ApiResponses(value = {
			@ApiResponse(code = 201, message = "Food Product with specified id was fetched sucessfully") })
	@GetMapping(value = "/foodProducts", produces = { MediaType.APPLICATION_JSON_VALUE })
	public List<FoodProduct> getAllFoodProduct() {
		return foodProductService.getAllFoodProduct();
	}

	@ApiResponses(value = {
			@ApiResponse(code = 201, message = "Food Product with specified id was deleted sucessfully") })
	@DeleteMapping(value = "/foodProducts/{id}", produces = { MediaType.APPLICATION_JSON_VALUE })
	...
	@PutMapping(value = "/foodProducts", consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	...
	@PostMapping(value = "/menu", consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	...
	@PutMapping(value = "/menu", consumes = { MediaType.APPLICATION_JSON_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
